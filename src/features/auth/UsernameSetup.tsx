  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!trimmedUsername) {
      showToast({
        type: "error",
        title: "Attenzione",
        message: "Inserisci un username valido.",
      });
      return;
    }
    ...
    try {
      ...
      showToast({
        type: "success",
        title: "Benvenuto!",
        message: "Username impostato con successo.",
      });
      ...
      const msg =
        error.code === "23505"
          ...
          : error.message || "Impossibile impostare l'username.";
    ...
    <div className="us-container">
      <div className="us-card">
        <h1 className="us-title">
          Benvenuto in <span className="us-echo-pulse">ECHO</span>
        </h1>
